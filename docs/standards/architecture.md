...
| **Level 3** | **Sub-Rak (Sub-shelf)** | `SR-01-get-started/` | Track spesifik di dalam Rak. |
| **Level 4** | **Buku (Book)** | `BK-01_Basics/` | Koleksi bab terpadu. |
| **Level 5** | **Bab (Chapter)** | `CH-01_Overview/` | Unit materi inti (Folder Bab). |
