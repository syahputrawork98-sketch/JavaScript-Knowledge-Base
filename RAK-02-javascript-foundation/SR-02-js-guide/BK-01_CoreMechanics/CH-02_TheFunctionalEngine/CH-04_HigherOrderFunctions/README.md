...
## 🔗 Source Hub
- **Primary Source**: [MDN Web Docs - Higher-order functions](https://developer.mozilla.org/en-US/docs/Glossary/First-class_Function) (See section on HOF)
- **Practical Guide**: [Functional Programming in JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions)

## 🎓 Senior Terminology
- **Abstraction Layer**: Teknik menyembunyikan detail kompleks (seperti loop manual) di balik antarmuka yang lebih sederhana dan deskriptif.
- **Declarative vs Imperative**: Perbedaan antara memberi tahu program *apa* yang harus dilakukan (HOF) vs memberi tahu program *bagaimana* melakukannya baris demi baris (Manual Loop).
- **Function Composition**: Proses menggabungkan dua atau lebih fungsi untuk menghasilkan fungsi baru yang lebih kompleks dan modular.
