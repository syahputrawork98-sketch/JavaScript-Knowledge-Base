...
## 🎓 Senior Terminology
- **First-class Citizen**: Status di mana suatu entitas (dalam hal ini fungsi) bisa diperlakukan sama seperti tipe data dasar (string, number, dll) dalam sebuah bahasa pemrograman.
- **Function Expression**: Cara mendefinisikan fungsi dengan menyimpannya ke dalam variabel (tidak diangkat/hoisted secara penuh).
- **Callback Pattern**: Pola desain di mana sebuah fungsi dikirimkan sebagai argumen untuk dieksekusi oleh fungsi lain di masa mendatang.
