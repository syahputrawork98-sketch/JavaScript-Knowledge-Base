...
- **Technical Reference**: [ECMA-262 - Lexical this](https://tc39.es/ecma262/#sec-arrow-function-definitions-runtime-semantics-evaluation)

## 🎓 Senior Terminology
- **Lexical `this`**: Kondisi di mana nilai `this` di dalam fungsi mewarisi langsung dari scope tempat fungsi tersebut dibuat, bukan dari cara ia dipanggil.
- **Arguments Object Binding**: Perbedaan perilaku di mana Arrow Function tidak memiliki objek `arguments` miliknya sendiri.
- **Constructor Limitation**: Karakteristik Arrow Function yang tidak memiliki metode `[[Construct]]`, sehingga tidak bisa digunakan dengan kata kunci `new`.
