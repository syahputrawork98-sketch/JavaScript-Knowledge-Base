...
## 🎓 Senior Terminology
- **Base Case**: Kondisi penghenti dalam rekursi yang mencegah fungsi memanggil dirinya sendiri terus-menerus (Infinite Recursion).
- **Stack Overflow**: Galat yang terjadi saat tumpukan pemanggilan fungsi (Call Stack) melebihi kapasitas memori yang dialokasikan oleh environment.
- **Tail Call Optimization (TCO)**: Optimasi di mana pemanggilan fungsi terakhir dalam sebuah fungsi tidak menambah tumpukan baru di Call Stack (fitur spesifik di ES6 untuk rekursi yang efisien).
