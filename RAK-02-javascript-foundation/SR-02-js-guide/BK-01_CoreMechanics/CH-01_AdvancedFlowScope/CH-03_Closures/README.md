...
## 🎓 Senior Terminology
- **Persistent Lexical Scope**: Kemampuan fungsi untuk tetap mengakses scope tempat ia dibuat bahkan setelah scope tersebut secara teknis sudah selesai dieksekusi.
- **Encapsulation**: Teknik menyembunyikan detail implementasi dan data di dalam fungsi untuk menjaga integritas sistem (Data Privacy).
- **Static vs Dynamic Binding**: Closure membuktikan bahwa JavaScript menggunakan Static (Lexical) Binding, di mana scope ditentukan saat penulisan kode.
