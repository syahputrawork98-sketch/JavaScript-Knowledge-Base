...
## 🎓 Senior Terminology
- **Data vs Accessor Descriptor**: Perbedaan antara properti yang menampung nilai langsung dengan properti yang menggunakan fungsi `get` dan `set`.
- **Enumerable Attribute**: Bendera konfigurasi yang menentukan apakah sebuah properti akan terlihat saat dilakukan iterasi (seperti `Object.keys`).
- **Object.freeze() / Immutability**: Metode penguncian total sebuah objek agar tidak bisa dimodifikasi sama sekali, memastikan integritas data.
