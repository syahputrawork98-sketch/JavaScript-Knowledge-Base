...
- **Technical Reference**: [ECMA-262 - Ordinary Object Prototype Chain](https://tc39.es/ecma262/#sec-ordinary-object-internal-methods-and-internal-slots-getprototypeof)

## 🎓 Senior Terminology
- **Prototypal Inheritance**: Mekanisme JavaScript di mana sebuah objek mewarisi fitur dari objek lain melalui rantai rujukan internal (`[[Prototype]]`).
- **Prototype Chain**: Urutan rujukan dari satu objek ke prototipenya, dan seterusnya, hingga mencapai `null` yang mengakhiri rantai tersebut.
- **Property Shadowing**: Kondisi di mana sebuah properti didefinisikan pada objek instance, sehingga menutupi properti dengan nama yang sama yang ada di rantai prototipenya.
